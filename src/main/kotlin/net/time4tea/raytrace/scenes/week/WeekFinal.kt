...
class WeekFinal : Scene {
    ...
    override fun scene(): Hitable {
        ...
        val ground = Lambertian(ConstantTexture(Colour(0.48, 0.83, 0.53)))
        ...
        world.add(boundary1)
        world.add(ConstantMedium(boundary1, 0.2f, ConstantTexture(Colour(0.2, 0.4, 0.9))))
        ...
        val white = Lambertian(ConstantTexture(Colour(0.73, 0.73, 0.73)))
